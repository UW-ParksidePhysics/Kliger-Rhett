...
initial_position = vp.vector(-10., 10., 0.)
initial_velocity = vp.vector(25., -5., 0.)
initial_position2 = vp.vector(-10., -10., 0.)
initial_velocity2 = vp.vector(25., 5., 0.)
...
wall_dimensions = vp.vector(0.25, 20., 10.)
